        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    RelatedOrdersId = table.Column<Guid>(type: "uniqueidentifier", nullable: false)
                },
                constraints: table =>
                {
                    table.PrimaryKey("PK_OrderPizza", x => new { x.OrderItemsId, x.RelatedOrdersId });
                    table.ForeignKey(
                        name: "FK_OrderPizza_Orders_RelatedOrdersId",
                        column: x => x.RelatedOrdersId,
                        principalTable: "Orders",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Cascade);
                    table.ForeignKey(
                        name: "FK_OrderPizza_Pizzas_OrderItemsId",
            ...
            migrationBuilder.CreateIndex(
                name: "IX_OrderPizza_RelatedOrdersId",
                table: "OrderPizza",
                column: "RelatedOrdersId");
