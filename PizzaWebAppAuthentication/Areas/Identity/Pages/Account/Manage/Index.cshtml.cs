...
namespace PizzaWebAppAuthentication.Areas.Identity.Pages.Account.Manage
{
    public class IndexModel : PageModel
    {
        ...
        private async Task LoadAsync(ApplicationUser user)
        {
            ...
            var userId = user.Id;
            var firstName = _userManager.Users.Where(u => u.Id == userId).Select(c => c.FirstName).FirstOrDefault();
            var lastName = _userManager.Users.Where(u => u.Id == userId).Select(c => c.LastName).FirstOrDefault();
        ...
        public async Task<IActionResult> OnPostAsync()
        {
            ...
            var phoneNumber = await _userManager.GetPhoneNumberAsync(user);
            var userId = user.Id;
            var firstName = _userManager.Users.Where(u => u.Id == userId).Select(c => c.FirstName).ToString();
            var lastName = _userManager.Users.Where(u => u.Id == userId).Select(c => c.LastName).ToString();
